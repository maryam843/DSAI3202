...
class Explorer:
    ...
    def print_statistics(self, time_taken: float):
        ...
        print("\n===Initial Explorer Maze Exploration Statistics ===")
        ...
        if time_taken == 0:
            print("Error: Time taken is 0. Cannot calculate moves per second.")
        else:
            print(f"Average moves per second: {len(self.moves)/time_taken:.1f}")
        print("==================================\n")
